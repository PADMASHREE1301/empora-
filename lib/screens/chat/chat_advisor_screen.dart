...
class AdvisorConfigs {
  static AdvisorConfig taxation = const AdvisorConfig(
    ...
    greeting:
        'I\'m your personal CA and Tax Advisor. I can help you with income tax planning, GST compliance, TDS, startup exemptions, and tax-saving strategies.\n\nTell me about your business and I\'ll guide you step by step.',
    suggestions: [
  ...
  static AdvisorConfig licence = const AdvisorConfig(
    ...
    greeting:
        'I\'m your Licence Advisor. I help founders navigate the complex world of business licences, permits, and regulatory approvals.\n\nTell me your business type and I\'ll tell you exactly what licences you need.',
    suggestions: [
  ...
  static AdvisorConfig loans = const AdvisorConfig(
    ...
    greeting:
        'I\'m your Loan & Financial Advisor. I help founders find the right funding options — from bank loans to government schemes and investor funding.\n\nLet\'s find the best financing option for your business.',
    suggestions: [
  ...
  static AdvisorConfig project = const AdvisorConfig(
    ...
    greeting:
        'I\'m your Project Management Advisor. I help founders plan, execute, and deliver projects on time and within budget.\n\nWhat project challenge can I help you with?',
    suggestions: [
...
class _ChatAdvisorScreenState extends State<ChatAdvisorScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    if (mounted && _messages.isEmpty) {
      setState(() => _messages.add(
            _ChatMessage(text: _buildGreeting(), isUser: false)));
    }
  }
  ...
  Future<void> _send(String text) async {
    ...
    try {
      ...
      final profile =
          ...
          'Business: ${_bizName.isNotEmpty ? _bizName : (auth.user?.name ?? 'Not set')}';
  ...
  Future<void> _confirmClear() async {
    ...
    setState(() {
      ...
      _lastFailedMessage = '';
      _messages.add(_ChatMessage(text: _buildGreeting(), isUser: false));
    });
  }
  ...
  // ── Header ────────────────────────────────────────────────────────────────
  Widget _buildHeader(AdvisorConfig cfg) {
    return Container(
  ...
  // ── Chips ─────────────────────────────────────────────────────────────────
  Widget _buildChips(AdvisorConfig cfg) {
    return Container(
      color: Colors.white,
  ...
  // ── Input row ─────────────────────────────────────────────────────────────
  Widget _buildInputRow(AdvisorConfig cfg) {
    return Row(children: [
      Expanded(
        child: Container(
          decoration: BoxDecoration(
  ...
  Widget _buildItem(BuildContext context, int index) {
    ...
    return _buildMessage(_messages[index - msgOffset]);
  }
  ...
  Widget _buildMessage(_ChatMessage msg) {
    ...
    final isError = !isUser &&
        (msg.text.contains('trouble connecting') ||
            msg.text.contains('❌') ||
            msg.text.contains('📶') ||
            msg.text.contains('⏱️'));
