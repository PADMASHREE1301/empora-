...
class PendingApprovalScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      // ✅ FIX: resizeToAvoidBottomInset prevents keyboard overflow
      resizeToAvoidBottomInset: false,
      body: SafeArea(
        child: SingleChildScrollView(   // ✅ FIX: Scrollable so nothing overflows
            ...
            child: IntrinsicHeight(
              child: Column(
                children: [
                  ...
                  // ✅ FIX: Spacer replaced with Expanded to avoid overflow
                  ...
                  Text(
                    'Questions? Contact admin@empora.com',
                    textAlign: TextAlign.center,
                    style: GoogleFonts.inter(
                      fontSize: 12,
                      color: AppTheme.textSecondary,
